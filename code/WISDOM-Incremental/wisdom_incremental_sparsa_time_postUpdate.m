function [W, V, A, BT, C] = wisdom_incremental_sparsa_time_postUpdate(XT, Y, W_old, V_old, A_old, C_old, lambda2, eta2, beta2, R)
...
non_smooth = prox_L1(R, S, d, beta2);
...
if isnan(sum(vect_result))
    A = A_old; BT = BT_old; C = C_old; W = W_old; V = V_old;
else
...
function op = prox_L1(R, T, d, beta2) 
