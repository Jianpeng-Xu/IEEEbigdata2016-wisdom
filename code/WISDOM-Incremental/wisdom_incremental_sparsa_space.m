function [W, V, AS, B, C] = wisdom_incremental_sparsa_space(XS, Y, W_old, V_old, B_old, C_old, lambda1, eta1, beta1, R)
...
non_smooth = prox_L1(R, T, d, beta1);
...
if isnan(sum(vect_result))
    AS = AS_old; B = B_old; C = C_old; W = W_old; V = V_old;
else
...
function op = prox_L1(R, T, d, beta1) 
